...
// Classe estática que armazena dados relacionados aos Tetrominos
public static class Data
{
    // Matriz de rotação para rodar as peças
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f); // Cosseno de 90 graus
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f); // Seno de 90 graus
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos }; // Matriz de rotação

    // Dados das células de cada tipo de Tetromino
    ...
    // Dados dos "wall kicks" para o Tetromino I
    ...
    // Dados dos "wall kicks" para os outros Tetrominos
    ...
    // Mapeamento dos "wall kicks" para cada tipo de Tetromino
